    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div>
            ...
            <li class="list-inline-item">
                <a href="https://www.linkedin.com/in/ryancoughlin5/" target="_blank">
            ...
            <li class="list-inline-item">
              <a href="https://github.com/ryancoughlin5" target="_blank">
                <span class="fa-stack fa-lg">
                  <i class="fa fa-circle fa-stack-2x"></i>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          ...
          <p class="mb-5"> I am currently a Senior Business Analytics/Information Systems major, and I will be seeking full-time employment
            ...
            teach character, teamwork, time management, and what it takes to be successful, just to name a few. I believe
            my willingness to put everything I have into whatever I am doing stems from my background of playing sports.</p>
